    ...
    return (
        <NavigationMenu className="hidden md:block">
            <NavigationMenuList>
                    ...
                    <NavigationMenuLink href="/solutions">
                        ...
                        <NavigationMenuContent>
                            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                <ListItem href="/docs" title="Energy Saving">
                                    ...
                                </ListItem>
                                <ListItem href="/docs" title="Waste Reduction">
                                    ...
                                </ListItem>
                                <ListItem href="/docs" title="Sustainability">
                                    ...
                                </ListItem>
                                <ListItem href="/docs" title="Increased Throughput">
                                    ...
                                </ListItem>
                            </ul>
                        </NavigationMenuContent>
                ...
                <NavigationMenuItem>
                    <Input type="text" placeholder="Search catalog" className="rounded-full pl-3 text-slate-500 border-2 border-transparent hover:border-black focus:border-black" />
                </NavigationMenuItem>
